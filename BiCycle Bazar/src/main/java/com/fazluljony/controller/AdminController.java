...
public class AdminController {
	...
	public String addProductpost(@Valid @ModelAttribute("product") Product product, BindingResult result, HttpServletRequest request ) {
		...
		Path path = Paths.get("G:\\JavaEEprojectssd\\eMusicStore\\src\\main\\webapp\\WEB-INF\\resources\\images\\"+product.getProductId()+".png");
	...
	public String deleteProduct(@PathVariable("id") String id , Model model, HttpServletRequest request ) {
		...
		Path path = Paths.get("G:\\JavaEEprojectssd\\eMusicStore\\src\\main\\webapp\\WEB-INF\\resources\\images\\"+id+".png");
